          ...
          <aside class="
               ...
               <div class="sidenav-header">
                    ...
                    <a class="navbar-brand m-0" href="#" target="_blank">
                         <img src="<?php echo base_url('/assets/img/utdi.png') ?>" class="navbar-brand-img h-100" alt="main_logo" />
               ...
               <div class="
                    ...
                    <ul class="navbar-nav">
                         ...
                         <?php if ($current_user->level == '1') { ?>
                              <li class="nav-item">
                                   <a class="nav-link <?php echo $this->uri->segment(2) == 'mahasiswa' ? 'active' : '' ?>" href="<?php echo site_url('/admin/mahasiswa') ?>">
                                        <div class="
                                             icon icon-shape icon-sm
                                             shadow
                                             border-radius-md
                              ...
                              <li class="nav-item">
                                   <a class="nav-link <?php echo $this->uri->segment(2) == 'kriteria' ? 'active' : '' ?>" href="<?php echo site_url('/admin/kriteria') ?>">
                                        <div class="
                                             icon icon-shape icon-sm
                                             shadow
                                             border-radius-md
                              ...
                              <li class="nav-item">
                                   <a class="nav-link <?php echo $this->uri->segment(2) == 'bobot' ? 'active' : '' ?>" href="<?php echo site_url('/admin/bobot') ?>">
                                        <div class="
                                             icon icon-shape icon-sm
                                             shadow
                                             border-radius-md
                         ...
                         <?php } ?>
                         <li class="nav-item">
                              <a class="nav-link <?php echo $this->uri->segment(2) == 'penilaian' ? 'active' : '' ?> " href="<?php echo site_url('/admin/penilaian') ?>">
                         ...
                         <li class="nav-item">
                              <a class="nav-link <?php echo $this->uri->segment(2) == 'hasil' ? 'active' : '' ?>" href="<?php echo site_url('/admin/hasil') ?>">
                                   <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                         ...
                         <?php if ($current_user->level == '1') { ?>
                              <li class="nav-item">
                                   <a class="nav-link <?php echo $this->uri->segment(2) == 'DataPengurus' ? 'active' : '' ?>" href="<?php echo site_url('/admin/DataPengurus') ?>">
                                        <div class="
                                             icon icon-shape icon-sm
                                             shadow
                                             border-radius-md
                         ...
                         <?php if ($current_user->level == '2') { ?>
                              <li class="nav-item">
                                   <a class="nav-link <?php echo $this->uri->segment(3) == 'setting' ? 'active' : '' ?>" href="<?php echo site_url('/admin/DataPengurus/setting') ?>">
                                        <div class="
                                             icon icon-shape icon-sm
                                             shadow
                                             border-radius-md
